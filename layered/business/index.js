...
app.get('/universities', function (req, res) {
  request.get('http://127.0.0.1:5000/universities', function (error, response, body) {
...
app.get('/university/:id', function (req, res) {
  ...
  var universityReq = {
    url: 'http://127.0.0.1:5000/university/' + req.params["id"],
    method: 'GET'
  };

  var depsReq = {
    url: 'http://127.0.0.1:5000/departments/' + req.params["id"],
    method: 'GET'
  };
...
app.get('/department/:id', function (req, res) {
  var departmentReq = {
    url: 'http://127.0.0.1:5000/department/' + req.params["id"],
    method: 'GET'
  };

  var coursesReq = {
    url: 'http://127.0.0.1:5000/courses/' + req.params["id"],
    method: 'GET'
  };
...
app.get('/course/:id', function (req, res) {
  var courseReq = {
    url: 'http://127.0.0.1:5000/course/' + req.params["id"],
    method: 'GET'
  };

  var textbooksReq = {
    url: 'http://127.0.0.1:5000/textbooks/' + req.params["id"],
    method: 'GET'
  };
...
app.get('/textbook/:id', function (req, res) {
  request.get('http://127.0.0.1:5000/textbook/' + req.params["id"], function (error, response, body) {
    if (response.statusCode == 200) {
      res.send(response.body);
    } else {
      res.send({ "Status": 500 });
...
app.get('/orders', function (req, res) {
  request.get('http://127.0.0.1:5000/orders', function (error, response, body) {
    if (response.statusCode == 200) {
      res.send(response.body);
    } else {
      res.send({ "Status": 500 });
...
app.get('/orders/:id', function (req, res) {
  var orderReq = {
    url: 'http://127.0.0.1:5000/order/' + req.params["id"],
    method: 'GET'
  };
  ...
  apiCall(orderReq).then(result => {
    ...
    var textbookReq = {
      url: 'http://127.0.0.1:5000/textbooks/' + result[0].textbook,
      method: 'GET'
    };
...
app.post('/order', function (req, res) {
  var options = {
    ...
    body: req.body,
    json: true,
    url: 'http://127.0.0.1:5000/order/new'
  }
...
app.put('/order/:id', function (req, res) {
  request.put('http://127.0.0.1:5000/order/edit/' + req.params['id'], { form: { data: req.body } }, function (error, response, body) {
    if (response.statusCode == 200) {
      res.send(response.body);
    } else {
      res.send({ "Status": 500 });
...
app.delete('/order/:id', function (req, res) {
  request.delete('http://127.0.0.1:5000/order/delete/' + req.params['id'], function (error, response, body) {
    if (response.statusCode == 200) {
      res.send(response.body);
    } else {
      res.send({ "Status": 500 });
