...
app.get('/universities', function (req, res) {
  request.get('http://127.0.0.1:5005/universities', function (error, response, body) {
...
app.get('/university/:id', function (req, res) {
  ...
  var universityReq = {
    url: 'http://127.0.0.1:5005/university/' + req.params["id"],
    method: 'GET'
  };

  var depsReq = {
    url: 'http://127.0.0.1:5005/departments/' + req.params["id"],
    method: 'GET'
  };
...
app.get('/department/:id', function (req, res) {
  var departmentReq = {
    url: 'http://127.0.0.1:5005/department/' + req.params["id"],
    method: 'GET'
  };

  var coursesReq = {
    url: 'http://127.0.0.1:5005/courses/' + req.params["id"],
    method: 'GET'
  };
...
app.get('/course/:id', function (req, res) {
  var courseReq = {
    url: 'http://127.0.0.1:5005/course/' + req.params["id"],
    method: 'GET'
  };

  var textbooksReq = {
    url: 'http://127.0.0.1:5005/textbooks/' + req.params["id"],
    method: 'GET'
  };
...
app.get('/textbook/:id', function (req, res) {
  request.get('http://127.0.0.1:5005/textbook/' + req.params["id"], function (error, response, body) {
    if (response.statusCode == 200) {
      res.send(response.body);
    } else {
      res.send({ "Status": 500 });
...
app.get('/orders', function (req, res) {
  request.get('http://127.0.0.1:5005/orders', function (error, response, body) {
    if (response.statusCode == 200) {
      res.send(response.body);
    } else {
      res.send({ "Status": 500 });
...
app.get('/orders/:id', function (req, res) {
  ...
  apiCall(orderReq).then(result => {
    ...
    var textbookReq = {
      url: 'http://127.0.0.1:5005/textbooks/' + result[0].textbook,
      method: 'GET'
    };
